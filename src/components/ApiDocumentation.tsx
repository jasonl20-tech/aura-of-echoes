    ...
    <div className="space-y-6 max-w-6xl mx-auto p-4">
      <div className="text-center mb-8">
        ...
        <p className="text-white/70">
          Komplette Anleitung zur Integration des receive-message Endpoints
        </p>
      </div>
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>4. Du sendest Antwort → <code className="bg-black/30 px-2 py-1 rounded">receive-message</code> function</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                <span>5. Nachricht erscheint im Chat</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="glass rounded-lg p-3 flex items-center justify-between">
                ...
                <button
                  onClick={() => copyToClipboard(receiveMessageUrl, 'URL')}
